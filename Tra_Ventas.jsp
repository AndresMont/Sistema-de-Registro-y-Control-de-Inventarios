...
<html>
    <head>
        ...
        <script type="text/javascript">
            function campos() {
                ...
                if (c.value !== "0" & d.value !== "" & e.value !== "" & f.value !== "" & g.value !== "") {
                    return true;
                } else {
                    if (c.value === "0") {
    ...
    <sql:query var="resultado" dataSource="${con}">
        SELECT * FROM INVENTARIOSPI.INV_DOCUMENTOS WHERE DOC_TIPO_DOCUMENTO = 'FV'
    </sql:query>
    ...
    <center>
                ...
                <table border="0" cellspacing="8">
                    <tbody>
                        ...
                        <tr><td colspan="2"><br>Los datos con (*) son obligatorios.</td> <td>Total:</td>
                            <td><input type="text" name="tot" size="40" id="tot"  disabled ></td>
        ...
        <c:if test="${param.modificar != null}">
            ...
            <sql:update var="gua" dataSource="${con}">
                ...
                DOC_TOTAL, 
                DOC_TIPO_DOCUMENTO) 
                VALUES ('${cont+1}', '1','${param.bod}', '${suc_id}', '${usu_id}','${param.cli}','${param.num}', STR_TO_DATE('${param.fec}', '%d/%m/%Y'), '${param.hor}', '${param.ite}', '${param.sub}', '${param.iva}', '${param.tot}', 'FV');
            </sql:update>
            <script>
                function extraer() {
                <sql:query var="counts" dataSource="${con}">
...
//****************************************************************RELACIONES**********************************************************// 
            ...
            <form action="Tra_Ventas.jsp" method='post' >
