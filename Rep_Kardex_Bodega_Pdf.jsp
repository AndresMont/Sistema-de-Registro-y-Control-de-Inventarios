...
<html>
    ...
    <body>
       <%
         File reportfile = new File(application.getRealPath("Rep_Reportes/Rep_Kardex_Bodega.jasper"));
        
           Map<String,Object> parameter = new HashMap<String,Object>();
           String valor = request.getParameter("pro");
             String valor2 = request.getParameter("bode");
             System.out.println(valor+" "+valor2);
           parameter.put("pro", new String(valor));
           parameter.put("bod", new String(valor2));
